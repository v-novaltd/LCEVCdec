...
// test this on Windows until we have proper API logging, or use linker .def file rather than attributes
// to specify imports.
//
#if !VN_OS(WINDOWS)
...
TEST(Configure, All)
{
    ...
    EXPECT_EQ(os.str(), "LCEVC_ConfigureDecoderBoolArray(1554, \"ba\", true, false, true, false)\n");
    os.str("");
    ...
    EXPECT_EQ(
        os.str(),
        "LCEVC_ConfigureDecoderStringArray(1554, \"strs\", alpha, bravo, charlie, delta, foxtrot)\n");
    os.str("");
    ...
    EXPECT_EQ(
        ...
        "LCEVC_ConfigureDecoderFloat(1554, \"yadayayd\", 42.2)\n"
        "LCEVC_ConfigureDecoderFloatArray(1554, \"floats\", 10, 11.1, 9087.3, 78786.2, 89, 0, 3.14)\n"
