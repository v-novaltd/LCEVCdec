...
TEST(PictureLayout, NV12_720x576)
{
    ...
    EXPECT_EQ(pl.planeSize(1), 103680);
    EXPECT_EQ(pl.planeSize(2), 103680);
...
TEST(PictureLayout, RGB_8_3840x2160)
{
    ...
    EXPECT_TRUE(pl.isValid());
    EXPECT_EQ(pl.planes(), 3);
    EXPECT_EQ(pl.planeGroups(), 1);

    EXPECT_EQ(pl.planeOffset(0), 0);
    EXPECT_EQ(pl.planeOffset(1), 1);
    EXPECT_EQ(pl.planeOffset(2), 2);

    EXPECT_EQ(pl.planeSize(0), 6220800);
    EXPECT_EQ(pl.planeSize(1), 6220800);
    EXPECT_EQ(pl.planeSize(2), 6220800);
...
TEST(PictureLayout, RGBA_8_3840x2160)
{
    ...
    lcevc_dec::utility::PictureLayout pl(pd);
    EXPECT_TRUE(pl.isValid());
    EXPECT_EQ(pl.planes(), 4);
    EXPECT_EQ(pl.planeGroups(), 1);

    EXPECT_EQ(pl.planeOffset(0), 0);
    EXPECT_EQ(pl.planeOffset(1), 1);
    EXPECT_EQ(pl.planeOffset(2), 2);
    EXPECT_EQ(pl.planeOffset(3), 3);

    EXPECT_EQ(pl.planeSize(0), 4147200);
    EXPECT_EQ(pl.planeSize(1), 4147200);
    EXPECT_EQ(pl.planeSize(2), 4147200);
    EXPECT_EQ(pl.planeSize(3), 4147200);
