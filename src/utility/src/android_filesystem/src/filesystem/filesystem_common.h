...
namespace detail { namespace {
    ...
    struct ErrorHandler
    {
        ...
        T report(const error_code& m_ec) const
        {
            ...
            switch (bool(p1) + bool(p2)) {
                ...
                case 1: __throw_filesystem_error(what, *p1, m_ec);
                case 2: __throw_filesystem_error(what, *p1, *p2, m_ec);
            }
            _LIBCPP_UNREACHABLE();
        }
    ...
    struct time_util_base
    {
        ...
        static constexpr rep min_nsec_timespec =
            duration_cast<fs_nanoseconds>((FileTimeT::duration::min() - fs_seconds(min_seconds)) +
                                          fs_seconds(1))
                .count();
    ...
    public:
        ...
        static _LIBCPP_CONSTEXPR_AFTER_CXX11 bool set_times_checked(TimeT* sec_out,
                                                                    SubSecT* subsec_out, FileTimeT tp)
        {
