        ...
        while (true) {
            ...
            if (str == "." || str == "..") {
                ...
                __entry_.__assign_iter_entry(
                    __root_ / str, directory_entry::__create_iter_result(str_type_pair.second));
                return true;
            }
        }
    }
...
recursive_directory_iterator::recursive_directory_iterator(const path& p, directory_options opt,
                                                           error_code* ec)
    : __imp_(nullptr)
    , __rec_(true)
{
