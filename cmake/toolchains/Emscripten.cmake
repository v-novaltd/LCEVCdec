...
# One more check: try EMSCRIPTEN_ROOT_PATH (this appears to be mandatory for the build step anyway)
if ("${EMSCRIPTEN_ROOT_PATH}" STREQUAL "")
...
# Abort if not found.
if ("${EMSCRIPTEN_ROOT_PATH}" STREQUAL "")
  message(FATAL_ERROR "Could not locate the Emscripten compiler toolchain directory! Either set the EMSCRIPTEN_ROOT_PATH environment variable, or pass -DEMSCRIPTEN_ROOT_PATH=xxx to CMake to explicitly specify the location of the compiler!")
endif()
